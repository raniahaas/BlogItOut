  ...
  let projects = [
    {
      ...
      bullets: [
        ...
        "Completed PCB designs from scratch to production",
        "Continued work on sensor integration in real time",
        "Developed a new real-time server with the ESP to retrieve CSV & live data",
      ],
      links: [
